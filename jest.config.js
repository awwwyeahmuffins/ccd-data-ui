...
export default {
  ...
  moduleNameMapper: {
    ...
    '^\\./(precinctHistory|turnoutSimulator|precinctProfile|electionTrends|dataLoader|electionFilters|fieldOnePager|v3Pivot|talkingPointsBuilder|targeting|utils)\\.js$': '<rootDir>/js/$1.js',
    // Map test-helpers
